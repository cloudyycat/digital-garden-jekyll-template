...
<p style="padding: 3em 1em; background: #e9f4be; border-radius: 4px;">
  If my writing is an ecosystem of interconnected practices that feed into one another, like the different flora and fauna that comprise a garden, then website is me, giving you a flower. Please feel free to find a shady spot and stay for a while. 
